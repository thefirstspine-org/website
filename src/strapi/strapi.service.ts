...
export class StrapiService {
  ...
  async getPageData(path: string | null): Promise<PageData | null> {
    ...
    // Get the blocks
    const blocks = await this.callApi(`blocks?populate[0]=content&populate[1]=content.button1&populate[2]=content.button2&populate[3]=content.button3&populate[4]=background&populate[5]=image&populate[6]=content.media&filters[page][documentId][$eq]=${page.documentId}`);
